...
//Olá Mundo!
function aa() {
    document.getElementById("mostrar").innerHTML = "carros";
    console.log(`carros`);
    alert(`Carros`);
  }
  
function be() {
    document.getElementById("mostrar").innerHTML = "help";
    console.log(`help`);
    alert(`Avestruzes`);
  }
  ...
  function nomeDigitado() {
    document.getElementById("mostrar").innerHTML = "Olá " + nome.value + ", seu nome e dahora ";
  }
  ...
  function div() {
    ...
    var resto = valor % 3;
    document.getElementById("mostrar").innerHTML =
      "metade pro amigo: " + metade_inteira + "<br>" + "resto pro mindingo: " + resto;
  }
  ...
  function pot() {
    ...
    document.getElementById("mostrar").innerHTML =
      "O quadrado em 3d vulgo cubo é:: " +
      potencia +
      "<br>" +
      "A raiz cubica 2d vulgo quadrada é: " +
      raiz +
      "<br>";
  }
  ...
  function maioridade() {
    ...
    if (idade < maioridade) {
      ...
      document.getElementById("mostrar").innerHTML =
        "ixiii, falta " + tempo + " ano(s) para tu pode beber, mas c ja quiser fzr o teste drive, da nd nao";
    } else {
      document.getElementById("mostrar").innerHTML =
        "avveee, o mano ja pode bebe junto do ao mosso";
    }
  }
  ...
  function dias() {
    ...
    document.getElementById("mostrar").innerHTML =
      "Já passou " + dias + " dias desde a morte de cristo segunto a data católica, se vc for ateu e dede o dia 01/01/0001";
  }
