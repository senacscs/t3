...
function olaMundo() {
    ...
    alert(`Olá Mundo eu sou o Gabriel!`);
  }
  
  //Numero digitado
  function numeroDigitado() {
    document.getElementById("mostrar").innerHTML =
      "O número digitado por voce foi " + numero.value;
  }
  
  //Nome digitado
  function nomeDigitado() {
    document.getElementById("mostrar").innerHTML = "Dei uma olhada aqui e voce esta devendo 300R$ em nossa loja" + nome.value;
  }
  
  //Operação simples
  function calcular() {
    var primNum = document.getElementById("segundoNum").value;
    var segmNum = document.getElementById("primeiroNum").value;
  ...
  //Troca de variáveis
  function troca() {
    var b = document.getElementById("primeiraVar").value;
    var a = document.getElementById("segundaVar").value;
  ...
  function maioridade() {
    ...
    if (idade < maioridade) {
      ...
      document.getElementById("mostrar").innerHTML =
        "Faltam " + tempo + " ano(s) para você atingir a maioridade consulte novamente depois dos anos que foi informado";
    } else {
      document.getElementById("mostrar").innerHTML =
        "Você já atingiu a maioridade agora voce pode ser preso";
    }
  }
  ...
  function altura() {
    ...
    document.getElementById("mostrar").innerHTML =
      "sua altura media é: " + Math.round(media_altura) + " metros";
  }
  
  //Loja de ferramentas
  function loja() {
    const preco_parafuso = 1.2;
    const preco_arruelas = 2.5;
    const preco_porca = 2.8;
    ...
    document.getElementById("mostrar").innerHTML =
      ...
      "===============================" +
      "<br>" +
      "O valor que o senhor vai ter que pagar e de: R$" +
      total;
  }
  ...
  //Média
  function media() {
    var m2 = parseFloat(document.getElementById("primeiraMedia").value);
    var m3 = parseFloat(document.getElementById("segundaMedia").value);
    var m1 = parseFloat(document.getElementById("terceiraMedia").value);
  ...
  function mediaFinal() {
    ...
    var nota2 = parseFloat(document.getElementById("primeiraNota").value);
    var nota3 = parseFloat(document.getElementById("segundaNota").value);
    var nota1 = parseFloat(document.getElementById("terceiraNota").value);
