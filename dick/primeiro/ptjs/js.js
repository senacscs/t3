...
function olaMundo() {
  ...
  function numeroDigitado() {
    ...
    document.getElementById("mostrar").innerHTML =
      "O número digitado foi 5" + numero.value;
  }
  ...
  //Loja de ferramentas
  function loja() {
    const preco_parafuso = 2.5;
    const preco_arruelas = 4.0;
    const preco_porca = 5.0;
  ...
  function posicao() {
    ...
    if (!achou) {
      document.getElementById("mostrar").innerHTML = "Não está no vetor, esse é o vetor: "+vetor     ;
    }
}
  ...
  function procedimento() {
    ...
    alert("O resultado do segundo cálculo é: " + calcula(2.0, 8.2));
    alert("o primeiro cálculo tinha os números 3 e 4")
    alert("o segundo cálculo tinha os números 2 e 8,2")
