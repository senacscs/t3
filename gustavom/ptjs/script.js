//Olá Mundo!
function olaMundo() {
  document.getElementById("mostrar").innerHTML = "Opa";
  console.log(`Opa`);
  alert(`Opa`);
}
...
function nomeDigitado() {
  document.getElementById("mostrar").innerHTML = "Olá " + nome.value + ", seja bem vindo(a)";
}
...
//Loja de ferramentas
function loja() {
  const preco_parafuso = 100;
  const preco_arruelas = 50;
  const preco_porca = 5;
...
function tabela() {
  ...
  let altura = [1.50, 1.60, 1.70, 1.58, 1.31];
