//Olá Mundo!
function olaMundo() {
  document.getElementById("mostrar").innerHTML = "Hello";
  console.log(`Hello`);
  alert(`Hello`);
}
...
function numeroDigitado() {
  document.getElementById("mostrar").innerHTML =
    "O número digitado foi " + numero.value *50;
}

//Nome digitado
function nomeDigitado() {
  document.getElementById("mostrar").innerHTML = "Olá " + nome.value + "!, prazer em conhece-lô";
}
...
function altura() {
  ...
  //kajhs
  media_altura = (altura1 + altura2 + altura3) / 1;
...
//Loja de ferramentas
function loja() {
  const preco_parafuso = 1000;
  const preco_arruelas = 150;
  const preco_porca = 58;
...
function vogal() {
  ...
  if (
    ...
    document.getElementById("mostrar").innerHTML =
      "A letra " + letra + " é uma vogal (pog)";
  } else {
    document.getElementById("mostrar").innerHTML =
      "A letra " + letra + " é uma consoante (paia)";
  }
}
...
//Tabela de dados
function tabela() {
  let nome = ["Andre", "Marcos", "Breno", "Augusto", "Vini"];
  let altura = [1.56, 1.67, 1.20, 1.28, 1.11];
