...
//Olá Mundo!
function olaMundo() {
    document.getElementById("mostrar").innerHTML = "Bom dia!";
    console.log(`Bom dia!`);
    alert(`Bom dia!`);
  }
  ...
  function numeroDigitado() {
    document.getElementById("mostrar").innerHTML =
      "O número que você pensou foi " + numero.value;
  }
  ...
  function maioridade() {
    ...
    if (idade < maioridade) {
      ...
      document.getElementById("mostrar").innerHTML =
        "Faltam " + tempo + " ano(s) para você ser preso";
    } else {
      document.getElementById("mostrar").innerHTML =
        "Você ja pode ser preso ein, tome cuidado!";
    }
  }
  ...
  //Loja de ferramentas
  function loja() {
    const preco_parafuso = 99.000;
    const preco_arruelas = 39.999;
    const preco_porca = 69.999;
  ...
  //Tabela de dados
  function tabela() {
    let nome = ["Tomás", "Gustavo", "Luciano", "Vittor", "Davi"];
    let altura = [1.71, 1.86, 1.66, 1.64, 1.79];
