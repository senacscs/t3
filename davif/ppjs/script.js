...
function olaMundo() {
  ...
  function numeroDigitado() {
    document.getElementById("mostrar").innerHTML =
      "O número digitado foi " + numero.value + " e seu triplo é" + numero. value ;
  }
  
  //Nome digitado
  function nomeDigitado() {
    document.getElementById("mostrar").innerHTML = "" + nome.value; 
  }
  ...
  function inverterNome() {
    ...
    document.getElementById("mostrar").innerHTML = "" + nomeInvertido.value;
  }
