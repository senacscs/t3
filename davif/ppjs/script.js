...
//Olá Mundo!
function olaMundo() {
    document.getElementById("mostrar").innerHTML = "Bem vindo ao projeto Davi!";
    console.log(`Bem vindo ao projeto Davi!`);
    alert(`Bem vindo ao projeto Davi!`);
  }
  ...
  function nomeDigitado() {
    document.getElementById("mostrar").innerHTML = "1000 anos de azar para você " + nome.value; 
  }

  //Estenção do código nome digitado
  function inverterNome(nome) {
    // Divide o nome completo em palavras (assumindo que o nome seja uma única string)
    const palavras = nome.split(" ");
  
    // Inverte a ordem das palavras e as junta novamente
    const nomeInvertido = palavras.reverse().join(" ");
  ...
  function maioridade() {
    ...
    if (idade < maioridade) {
      ...
      document.getElementById("mostrar").innerHTML =
        "Faltam " + tempo + " ano(s) para você poder entrar na yves sem termo!";
    } else {
      document.getElementById("mostrar").innerHTML =
        "dezoitouuuuu!";
    }
  ...
  function vogal() {
    ...
    if (
      ...
      document.getElementById("mostrar").innerHTML =
        "A letra " + letra + " é uma vogal, perfeito meu veio!";
    } else {
      document.getElementById("mostrar").innerHTML =
        "A letra " + letra + " é uma consoante mula!";
    }
  }
  ...
  function media() {
    ...
    if (m1 < media) {
      document.getElementById("mostrar").innerHTML =
        ...
        Math.round(media) +
        "<br>" +
        "A média 1 é menor que a média final, ta quase fiote!";
    } else if (m2 < media) {
      document.getElementById("mostrar").innerHTML =
        "A média final é: " +
        Math.round(media) +
        "<br>" +
        "A média 2 é menor que a média final, ta longe em meu galo!";
    } else if (m3 < media) {
      document.getElementById("mostrar").innerHTML =
        "A média final é: " +
        Math.round(media) + //akls
        "<br>" +
        "A média 3 é menor que a média final, piorou eu meu chefia!";
    }
  }
  ...
  function idade() {
    ...
    if (idade < 18) {
      document.getElementById("mostrar").innerHTML = "Você é menor de idade, lhe falta tempo!";
    } else {
      //kajs
      document.getElementById("mostrar").innerHTML = "Você é maior de idade, veio capenga!";
    }
  }
  ...
  function num() {
    ...
    if (num_digitado >= 0 && num_digitado <= 6) {
      if (num_digitado == num_sorteado) {
        document.getElementById("mostrar").innerHTML = "Os números são identicos!";
      } else {
        document.getElementById("mostrar").innerHTML =
      ...
      document.getElementById("mostrar").innerHTML =
        "O número digitado deve estar entre 0 e 32";
    }
  }
  ...
  function mediaFinal() {
    ...
    if (media >= 6) {
      document.getElementById("mostrar").innerHTML =
        "Parabéns, so a breja agora! " +
        nome +
        ", você foi aprovado com a média, com as calça na mão! " +
        Math.round(media);
    } else {
      document.getElementById("mostrar").innerHTML =
        "Que pena " +
        nome +
        ", você foi reprovado com a média, senta e chora! " +
        Math.round(media);
    }
  }
  ...
  function contagem() {
    ...
    function loop() {
      ...
      if (contador > 0) {
        ...
        document.getElementById("mostrar").innerHTML = "Kabumm!\n";
      }
    }
  ...
  //Tabela de dados
  function tabela() {
    let nome = ["Jubileu", "Rodrigo", "Robson", "Diogo", "Cassio"];
    let altura = [2.23, 1.87, 1.75, 1.53, 1.38];
