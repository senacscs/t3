...
function olaMundo() {
  ...
  function numeroDigitado() {
    document.getElementById("mostrar").innerHTML =
      "Seu número multiplicado por 10 é " + numero.value*10;
  }
  
  //Nome digitado
  function nomeDigitado() {
    document.getElementById("mostrar").innerHTML = "Feito meu mano " + nome.value;
  }
  ...
  function maioridade() {
    ...
    if (idade < maioridade) {
      ...
      document.getElementById("mostrar").innerHTML =
        "Faltam " + tempo + " para você poder votar";
    } else {
      document.getElementById("mostrar").innerHTML =
  ...
  //Loja de ferramentas
  function loja() {
    const preco_pneu = 754.9;
    const preco_oleo = 68.0;
    const preco_freio = 2.5;
  
    var nome = document.getElementById("nomeDigitado").value;
    var pneu = parseFloat(document.getElementById("pneu").value);
    var oleo = parseFloat(document.getElementById("oleo").value);
    var freio = parseFloat(document.getElementById("freio").value);
  
    var total_pneu = preco_pneu * parafusos;
    var total_oleo = preco_oleo * oleo;
    var total_freio = preco_freio * freio;
  
    var total = total_pneu + total_oleo + total_freio;
