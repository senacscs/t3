...
//Olá Mundo!
function olaMundo() {
    document.getElementById("mostrar").innerHTML = "BUNDA!";
    console.log(`BUNDA!`);
    alert(`script!👍(¬‿¬)( ͡° ͜ʖ ͡°)( ͡°( ͡° ͜ʖ( ͡° ͜ʖ ͡°)ʖ ͡°) ͡°)☜(ﾟヮﾟ☜)👍`);
  }
  
  //Numero digitado
  function numeroDigitado() {
    document.getElementById("mostrar").innerHTML =
      "O número digitado foi " + numero.value*222;
  }
  ...
  function calcular() {
    ...
    const resultado = Math.pow(parseFloat(primNum),parseFloat(segmNum));
    document.getElementById("mostrar").innerHTML = resultado.toString();
  }
}
