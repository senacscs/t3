...
function olaMundo() {
  ...
  function numeroDigitado() {
    document.getElementById("mostrar").innerHTML =
      "O número digitado foi 25" + numero.value;
  }
  
  //Nome digitado
  function nomeDigitado() {
    document.getElementById("mostrar").innerHTML = "Olá " + ResizeObserverSize.nome;
  ...
  function calcular() {
    ...
    if (sel == "opcao1") {
      ...
      const resultado = parseFloat(primNum) * parseFloat(segmNum);
      document.getElementById("mostrar").innerHTML = resultado.toString() + "2";
    }
  }
  ...
  function prioridades() {
    ...
    resultado = (1.0 + 2.0) / (3.0 * 4.0);
    document.getElementById("mostrar").innerHTML +=
      "Operação: (1 + 2) / (3 * 4) = " + resultado + "2" + "<br>";
  }
