...
//Olá Mundo!
function olaMundo() {
    document.getElementById("mostrar").innerHTML = "Luciano Flores H";
    console.log(`Luciano Flores H`);
    alert(`Luciano Flores H`);
  }
  ...
  function nomeDigitado() {
    document.getElementById("mostrar").innerHTML = "Voce está preso em nome da lei " + nome.value;
  }
  ...
  function maioridade() {
    ...
    if (idade < maioridade) {
      ...
      document.getElementById("mostrar").innerHTML =
        "Faltam " + tempo + " ano(s) para você poder ser preso";
    } else {
      document.getElementById("mostrar").innerHTML =
