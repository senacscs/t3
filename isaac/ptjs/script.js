...
//Olá Mundo!
  ...
  function numeroDigitado() {
    document.getElementById("mostrar").innerHTML =
      "O número digitado foi " + numero.value + " e seu triplo é " + numero.value * 3;
  }
  
  //Nome digitado
  function nomeDigitado() {
    document.getElementById("mostrar").innerHTML = "Olá " + nome.value + ", vc é legal.";
  }
  ...
  function altura() {
    ...
    var altura4 = parseFloat(document.getElementById("quartaAltura").value);
  ...
  function dias() {
    ...
    var diasr = (anoAtual - 1) * 365
    document.getElementById("mostrar").innerHTML =
      "Já se passaram " + dias + " dias desde 01/01/0001 contando com os anos bisextos e" + diasr + "sem contar os anos bisextos.";
  }
  ...
  function idade() {
    ...
    if (idade < 18) {
      document.getElementById("mostrar").innerHTML = "Você é de menor ainda";
    } else {
      //kajs
      document.getElementById("mostrar").innerHTML = "Você ja é de maior kkkk";
    }
  }
