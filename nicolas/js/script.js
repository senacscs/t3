...
function olaMundo() {
    ...
    alert(`Olá Senac Fecomércio`);
  }
  
  //Numero digitado
  function numeroDigitado() {
    document.getElementById("mostrar").innerHTML =
      "Seu número da SORTE " + numero.value;
  }
  
  //Nome digitado
 // Função para inverter o nome
function inverterNome() {
    ...
    document.getElementById("mostrar").innerHTML = "Nome invertido: " + nomeInvertido;
}
  ...
  function calcularTotal() {
    ...
    var quantidadeParafusos = parseInt(document.getElementById("parafusos").value) || 0;
    var quantidadeArruelas = parseInt(document.getElementById("arruelas").value) || 0;
    var quantidadePorcas = parseInt(document.getElementById("porcas").value) || 0;

    var precoParafuso = 1.0; // Preço unitário de um parafuso
    var precoArruela = 0.5; // Preço unitário de uma arruela
    var precoPorca = 0.75; // Preço unitário de uma porca

    var total = quantidadeParafusos * precoParafuso +
                quantidadeArruelas * precoArruela +
                quantidadePorcas * precoPorca;

    var resultado = "Resumo da Compra de " + nomeCliente + ":<br>";
    resultado += "Quantidade de Parafusos: " + quantidadeParafusos + "<br>";
    resultado += "Quantidade de Arruelas: " + quantidadeArruelas + "<br>";
    resultado += "Quantidade de Porcas: " + quantidadePorcas + "<br>";
    resultado += "Total da Compra: R$" + total.toFixed(2);
  ...
  function exibirResultado() {
      var nomeCandidato1 = document.getElementById("candidato1").value;
      var nomeCandidato2 = document.getElementById("candidato2").value;
  
      var resultado = "Resultado da Eleição:<br>";
      resultado += nomeCandidato1 + ": " + votosCandidato1 + " votos<br>";
      resultado += nomeCandidato2 + ": " + votosCandidato2 + " votos";
