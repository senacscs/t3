function olaMundo() {
  ...
  function numeroDigitado() {
    document.getElementById("mostrar").innerHTML =
      "O número digitado foi " + numero.value + " e o quintuplo é " + numero.value * 5;
  }
  
  function nomeDigitado() {
    document.getElementById("mostrar").innerHTML = "O carro digitado foi o " + nome.value;
  }
  ...
  function loja() {
    const preco_pregos = 3.5;
    const preco_furadeiras = 200.0;
    const preco_chavedefenda = 10.0;
  
    var nome = document.getElementById("nomeDigitado").value;
    var pregos = parseFloat(document.getElementById("pregos").value);
    var furadeiras = parseFloat(document.getElementById("furadeiras").value);
    var chavedefenda = parseFloat(document.getElementById("chavedefenda").value);
  
    var total_pregos = preco_pregos * pregos;
    var total_furadeiras = preco_furadeiras * furadeiras;
    var total_chavedefenda = preco_chavedefenda * chavedefenda;
  
    var total = total_pregos + total_furadeiras + total_chavedefenda;
