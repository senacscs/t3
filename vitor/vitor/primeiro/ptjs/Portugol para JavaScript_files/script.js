...
function numeroDigitado() {
  ...
  var resultado = numero * numero; // Multiplica o número por ele mesmo
  document.getElementById("mostrar").innerHTML =
    "O número digitado multiplicado por ele mesmo é " + resultado;
}


//Nome digitado
function nomeDigitado() {
  document.getElementById("mostrar").innerHTML = "Bom dia, " + nome.value;
}
...
function prioridades() {
  ...
  document.getElementById("mostrar").innerHTML +=
    "Compre casas e apartamentos aqui! " + resultado + "<br>";
}
...
function div() {
  ...
  var resto = valor % 3;
  document.getElementById("mostrar").innerHTML =
    "metade da metade da inteira: " + metade_inteira + "<br>" + "o RRResto: " + resto;
}
...
function pot() {
  ...
  document.getElementById("mostrar").innerHTML =
    "A NUMERAÇÃO MOSTRADA ao cubo É ASSIM: " +
    potencia +
    "<br>" +
    "A raiz quadradadadada do número é: " +
    raiz +
    "<br>";
}
...
function maioridade() {
  ...
  if (idade < maioridade) {
    ...
    document.getElementById("mostrar").innerHTML =
      "Faltam bem pouquinho para daqui pouco. " + tempo + " ano(s) para você atingir a maioridade";
  } else {
    document.getElementById("mostrar").innerHTML =
